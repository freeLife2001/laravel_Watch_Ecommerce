                            ...
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <p><del> <?php echo e(number_format($item->options->price)); ?></del> vnđ</p>
                                    </td>
                                    <td>
                                        <select name="total" class="total" at="<?php echo e($item->rowId); ?>">
                                            <?php if($item->options->total>0): ?>
                                                <?php for($i=1;$i<=$item->options->total;$i++): ?>
                                                    <option value="<?php echo e($i); ?>" <?php if($item->qty==$i): ?> selected <?php endif; ?>><?php echo e($i); ?></option>
                                                <?php endfor; ?>
                                            <?php endif; ?>
                                        </select>
                                    </td>
                                    <td><?php echo e(number_format($item->subtotal)); ?></td>
                                    <td><a href="<?php echo e(route('cart.delete',$item->rowId)); ?>"><i class="fa fa-window-close" aria-hidden="true"></i></a></td>
                                </tr>
                                ...
                                <div class="text-right">
                                    <?php if(Auth::user()): ?>
                                        <form method="post" action="<?php echo e(route('cart.create_bill')); ?>">
                                            ...
                                            <input type="text" hidden value="<?php echo e(json_encode($product_list)); ?>" name="bill">
