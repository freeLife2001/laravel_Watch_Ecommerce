<?php $__env->startSection('bercum'); ?>
    <a href="<?php echo e(route('users.create')); ?>">Tạo bài viết</a>
            ...
            <div class="panel">
                <form class="panel-body" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <textarea cols="18" rows="18" class="form-control my-editor" placeholder="Nội dung bài viết ..." name="body"></textarea>
                    </div>
