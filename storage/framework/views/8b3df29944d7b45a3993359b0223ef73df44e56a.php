...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-lg-12" style="margin-bottom: 10px">
            ...
            <a href="<?php echo e(route('products.create')); ?>" class="btn btn-info" style="margin-top: 10px"><i
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?php echo e(route('products.view',$item->id)); ?>" class="btn btn-info" title="Xem"><i
                                            class="icon-eye4"></i></a>
                                <a href="<?php echo e(route('products.edit',$item->id)); ?>" class="btn bg-brown" title="Sửa"><i
                                            class="icon-pencil6"></i></a>
                                <a href="<?php echo e(route('products.delete',$item->id)); ?>" class="btn btn-danger" title="Xóa"><i
