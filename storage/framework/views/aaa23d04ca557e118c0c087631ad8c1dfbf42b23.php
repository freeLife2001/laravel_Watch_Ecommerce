            ...
            <div class="row">
                ...
                <div class="col-md-8 col-sm-8">
                    <div class="product-details-col">
                        ...
                        <h2><?php echo e(number_format($product['price_discount'])); ?> vnđ<del> <?php echo e(number_format($product['price'])); ?> vnđ</del></h2>
                        ...
                        <p>
                            ...
                            <?php if($category_list): ?>
                                <?php $__currentLoopData = $category_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a href="<?php echo e(route('home.product_category',$item['id'])); ?>"><?php echo e($item['name']); ?></a>
