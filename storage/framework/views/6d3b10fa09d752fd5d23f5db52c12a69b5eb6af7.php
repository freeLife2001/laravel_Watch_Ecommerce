                        ...
                        <div class="col-md-3 col-sm-6 col-xs-6 full-wd-600">
                            <div class="shopping-col">
                                <div class="product-img">
                                    <a href="<?php echo e(route('home.view',$item->product_id)); ?>"><img src="<?php echo e(asset($item->avatar)); ?>" alt=""></a>
                                ...
                                <div class="product-info text-center">
                                    <h4><a href="<?php echo e(route('home.view',$item->product_id)); ?>"><?php echo e($item->name); ?></a></h4>
                                    <p><del><?php echo e(number_format($item->price)); ?> vnđ</del> <?php echo e(number_format($item->price_discount)); ?>vnđ</p>
                                </div>
                            </div>
                        </div>
