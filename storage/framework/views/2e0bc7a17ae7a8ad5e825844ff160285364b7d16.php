...
<div class="row">
    <div class="col-lg-12" style="margin-bottom: 10px">
        ...
        <a href="<?php echo e(route('category.create')); ?>" class="btn btn-info" style="margin-top: 10px"><i class="icon-googleplus5"></i> Thêm chuyên mục</a>
                ...
                <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="<?php echo e(route('category.view',$item->id)); ?>" class="btn btn-info" title="Xem"><i class="icon-eye4"></i></a>
                            <a href="<?php echo e(route('category.edit',$item->id)); ?>" class="btn bg-brown" title="Sửa"><i class="icon-pencil6"></i></a>
                            <a href="<?php echo e(route('category.delete',$item->id)); ?>" class="btn btn-danger" title="Xóa"><i class="icon-trash"></i></a>
                        </td>
                    </tr>
