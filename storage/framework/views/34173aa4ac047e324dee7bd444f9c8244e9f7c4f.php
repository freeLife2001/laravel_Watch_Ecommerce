            ...
            <div class="panel panel-flat">
                <div class="panel-body">
                    <div class="form-group form-group-material">
                        ...
                        <input type="text" class="form-control typeahead-basic" name="name" value="<?php echo e($bill['name']); ?>"
                               disabled>
                    </div>
                    <div class="form-group form-group-material">
                        <label class="display-block has-margin">Người mua</label>
                        <input type="text" class="form-control typeahead-basic" name="name" value="<?php echo e($bill['buyer']); ?>"
                               disabled>
                    </div>
                    <div class="form-group form-group-material">
                        <label class="display-block has-margin">Email</label>
                        <input type="text" class="form-control typeahead-basic" name="phone" value="<?php echo e($bill['email']); ?>"
                               disabled>
                    </div>
                    <div class="form-group form-group-material">
                        <label class="display-block has-margin">Số điện thoại</label>
                        <input type="text" class="form-control typeahead-basic" name="phone" value="<?php echo e($bill['phone']); ?>"
                               disabled>
                    </div>
                    <div class="form-group form-group-material">
                        <label class="display-block has-margin">Địa chỉ</label>
                        <input type="text" class="form-control typeahead-basic" name="address"
                               value="<?php echo e($bill['address']); ?>" disabled>
                    </div>

                    <div class="form-group form-group-material">
                        <label class="display-block has-margin">Số lượng hàng</label>
                        <input type="text" class="form-control typeahead-basic" name="name" value="<?php echo e($bill['total']); ?>"
                               disabled>
                    </div>
                    <div class="form-group form-group-material">
                        <label class="display-block has-margin">Tổng tiền</label>
                        <input type="text" class="form-control typeahead-basic" name="email" value="<?php echo e($bill['price']); ?>"
                               disabled>
                    </div>
                    <div class="form-group form-group-material">
                        <label class="display-block has-margin">Trạng thái</label>
                        <input type="text" class="form-control typeahead-basic" name="email"
                               value="<?php echo e($bill['status']==1?'Đã xác nhận':'Chờ xác nhận'); ?>" disabled>
                    </div>
                    <div class="form-group form-group-material">
                            ...
                            <?php if(!empty($product_list)): ?>
                                <?php $__currentLoopData = $product_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e(number_format($item['price_discount'])); ?> vnđ (
