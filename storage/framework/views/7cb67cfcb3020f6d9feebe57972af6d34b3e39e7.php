                    ...
                    <?php $__currentLoopData = $tag_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-2 col-sm-2 col-xs-3 wd50-480">
                            <div class="partner-logo">
                                <a href="<?php echo e(route('home.view',$item['id'])); ?>"><img src="<?php echo e(asset($item['avatar'])); ?>" alt=""><?php echo e($item['name']); ?></a>
                                <p><a href="#"><?php echo e($item['total_product']); ?> sản phẩm</a></p>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endif; ?>
