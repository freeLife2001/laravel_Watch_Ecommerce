                                ...
                                <?php $__currentLoopData = $new; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="item">
                                        <a href="<?php echo e(route('home.view',['id' => $item->id,'slug'=> str_slug($item->name)])); ?>">
                                            <img src="<?php echo e(asset($item->avatar)); ?>" class="img-responsive center-block"
                                                 alt="">
                                        </a>
    ...
    <section class="discount-section">
        <div class="container">
            ...
            <div class="row">
                ...
                <?php if(!empty($discount_big)): ?>
                    <div class="col-md-6 col-sm-12">
                        <div class="discount-col">
                            <a href="<?php echo e(route('home.view',['id'=>$item->id,'slug'=>str_slug($item->name)])); ?>"><img
                                        src="<?php echo e(asset($discount_big->avatar)); ?>" alt=""></a>
                            <div class="discounted-price">
                                <p><span><?php echo e(number_format($discount_big->price)); ?> vnđ</span>
                                    (còn <?php echo e(number_format($discount_big->price_discount)); ?> vnđ) </p>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
                            ...
                            <?php $__currentLoopData = $discount; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-6 col-sm-6">
                                    <div class="discount-col">
                                        ...
                                        <div class="discounted-price">
                                            <p><span><?php echo e(number_format($item->price)); ?> vnđ</span>
                                                (còn <?php echo e(number_format($item->price_discount)); ?> vnđ) </p>
                                        </div>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-6 full-wd-600">
                            <div class="shopping-col">
                                ...
                                <div class="product-info text-center">
                                    <h4>
                                        <a href="<?php echo e(route('home.view',['id'=>$item->id,'slug'=>str_slug($item->name)])); ?>"><?php echo e($item->name); ?></a>
                                    </h4>
                                    <p><?php echo e(number_format($item->price)); ?> vnđ</p>
                                </div>
                            </div>
                                    ...
                                    <div class="blog-info-box">
                                        <ul>
                                            <li><i class="fa fa-user" aria-hidden="true"></i> <a
                                                        href="javascript:void(0)"><?php echo e($item->user_create); ?></a></li>
                                        </ul>
                                    </div>
                                </div>
