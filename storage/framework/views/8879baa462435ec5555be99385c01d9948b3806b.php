...
<div class="navbar navbar-inverse bg-indigo">
    <div class="navbar-header">
        <a class="navbar-brand" href="index.html"><img src="<?php echo e(asset('assets/images/logo_light.png')); ?>" alt=""></a>
                ...
                <div class="sidebar-user-material">
                    <div class="category-content">
                        <div class="sidebar-user-material-content">
                            <a href="#"><img src="<?php echo e(asset('assets/images/demo/users/face11.jpg')); ?>" class="img-circle img-responsive" alt=""></a>
                    ...
                    <div class="navigation-wrapper collapse" id="user-nav">
                        <ul class="navigation">
                            <li class="divider"></li>
                            <li><a href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault();document.getElementById('logout-form').submit();"><i class="icon-switch2"></i> <span>Đăng xuất</span></a></li>
        ...
        <div class="content-wrapper">
            ...
            <div class="page-header page-header-default">
                ...
                <div class="breadcrumb-line">
                    <ul class="breadcrumb">
                        <li><a href="<?php echo e(route('admin.index')); ?>"><i class="icon-home2 position-left"></i> Trang chủ</a></li>
