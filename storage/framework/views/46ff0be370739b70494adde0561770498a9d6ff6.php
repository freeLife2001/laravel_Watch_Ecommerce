<?php $__env->startSection('bercum'); ?>
    <a href="<?php echo e(route('users.create')); ?>">Tạo sản phẩm</a>
...
<div class="row">
    ...
    <div class="col-lg-12" style="margin-bottom: 10px">
        <div class="panel">
            <input type="text" value="<?php if(!empty($tags)): ?> <?php echo e(json_encode($tags)); ?><?php else: ?> [] <?php endif; ?>" id="tag_list" hidden>
            ...
            <form class="panel-body" method="post">
                ...
                <div class="form-group">
                    ...
                    <textarea cols="18" rows="18" class="form-control my-editor" placeholder="Nội dung sản phẩm ..." name="contents"></textarea>
                </div>
                <div class="text-right">
                    <button type="submit" class="btn btn-primary">Tạo<i class="icon-arrow-right14 position-right"></i></button>
                </div>
            </form>
        </div>
    </div>
