...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-lg-12" style="margin-bottom: 10px">
            ...
            <a href="<?php echo e(route('posts.create')); ?>" class="btn btn-info" style="margin-top: 10px"><i
                    ...
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?php echo e(route('posts.view',$item->id)); ?>" class="btn btn-info" title="Xem"><i
                                            class="icon-eye4"></i></a>
                                <a href="<?php echo e(route('posts.edit',$item->id)); ?>" class="btn bg-brown" title="Sửa"><i
                                            class="icon-pencil6"></i></a>
                                <a href="<?php echo e(route('posts.delete',$item->id)); ?>" class="btn btn-danger" title="Xóa"><i
