...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-lg-12" style="margin-bottom: 10px">
            ...
            <a href="<?php echo e(route('users.create')); ?>" class="btn btn-info" style="margin-top: 10px"><i
                        ...
                        <div class="media">
                            <div class="media-left">
                                <a href="<?php echo e(asset('assets/images/demo/images/3.png')); ?>" data-popup="lightbox">
                                    <img src="<?php echo e(asset('assets/images/demo/users/face1.jpg')); ?>"
                            ...
                            <div class="media-body">
                                ...
                                <ul class="icons-list">
                                    <li><a class="btn btn-info" href="<?php echo e(route('users.view',$item->id)); ?>"
                                           data-popup="tooltip" title="Xem" data-container="body"><i
                                                    class="icon-eye4"></i></a></li>
                                    <li><a class="btn btn-success" href="<?php echo e(route('users.edit',$item->id)); ?>"
                                           data-popup="tooltip" title="Sửa" data-container="body"><i
                                                    class="icon-pencil6"></i></a></li>
                                    <li><a class="btn btn-danger" href="<?php echo e(route('users.delete',$item->id)); ?>"
