    ...
    <div class="row">
        ...
        <div class="col-lg-12" style="margin-bottom: 10px">
            <div class="panel">
                ...
                <input type="text" value="<?php if(!empty($category)): ?> <?php echo e(json_encode($category)); ?><?php else: ?> [] <?php endif; ?>"
                ...
                <form class="panel-body" method="post" action="<?php echo e(route('products.update',$data['id'])); ?>">
                    ...
                    <span class="input-group-btn">
                        ...
                        <input id="thumbnail" class="form-control" type="text" name="avatar" style="display: none"
                               value="<?php echo e(asset($data['avatar'])); ?>">
                    </div>
                    ...
                    <div class="form-group form-group-material">
                        ...
                        <input type="text" class="form-control typeahead-basic" name="price_discount"
                               value="<?php echo e($data['price_discount']); ?>">
                    </div>
                    <div class="form-group form-group-material">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="<?php echo e($category_used_list); ?>" data-role="tagsinput"
                               class="tagsinput-category" name="category">
                    </div>
                    <div class="form-group" style="display: none">
                        <label>Tag</label>
                        <input type="text" value="<?php echo e($tag_used_list); ?>" data-role="tagsinput" class="tagsinput-typeahead"
                               name="tag">
                    </div>
                    <div class="form-group">
                        ...
                        <textarea cols="18" rows="18" class="form-control my-editor" placeholder="Nội dung sản phẩm ..."
                                  name="contents"><?php echo $data['contents']; ?></textarea>
                    </div>
...
<?php $__env->startSection('js'); ?>
    ...
    <script type="text/javascript"
            src="<?php echo e(asset('assets/js/plugins/forms/inputs/typeahead/typeahead.bundle.min.js')); ?>"></script>
