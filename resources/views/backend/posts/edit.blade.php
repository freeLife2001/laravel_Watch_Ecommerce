...
@section('bercum')
    <a href="{{route('users.create')}}">Sửa bài viết</a>
@endsection
@section('css')
...
@section('content')
    <div class="row">
        ...
        <div class="col-lg-12" style="margin-bottom: 10px">
            <div class="panel">
                <form class="panel-body" method="post" action="{{route('posts.update',$data['id'])}}">
                    {{ csrf_field() }}
                    ...
                    <span class="input-group-btn">
                        ...
                        <input id="thumbnail" class="form-control" type="text" name="avatar"
                               value="{{asset($data['avatar'])}}" style="display: none">
                    </div>
                    ...
                    <div class="text-right">
                        <button type="submit" class="btn btn-primary">Sửa <i
